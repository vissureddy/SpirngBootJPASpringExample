...
public class BookingController {
	...
	public Booking create(Booking booking) {
		...
		booking.setDeparture("tpt");
		booking.setDestination("bng");
		booking.setPsngrName("viswa");
	 ...
	 */
	@RequestMapping("/read")
	public Booking read(@RequestParam int bookingId) {
	...
	public Booking update(@RequestParam int bookingId, @RequestParam String psngrName) {
		Booking booking = bookingRepository.findOne(bookingId);
	...
	public String delete(@RequestParam int bookingId) {
